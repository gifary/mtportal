...
<button class=" btn btn-pill btn-primary text-light" type="button" data-toggle="modal" data-target="#addLeadModal"
  data-whatever="@getbootstrap" id="addBusinessId" name="addBusinessId">Add Lead</button>
@endsection
@section('content')
              ...
              <div class="row">
                <div class="col">
                  <div class="form-group">
                    ...
                    <input required class="form-control" id="contact2" name="email" type="email" placeholder="email">
                  </div>
                </div>
                ...
                <div class="col">
                  <div class="form-group">
                    ...
                    <input class="form-control" id="dual_size" name="phone" type="number" placeholder="phone">
                  </div>
                </div>
              </div>
              <div class="row">
                ...
                <div class="col">
                  <div class="form-group">
                    ...
                    <input required class="form-control" id="closed_won_date" name="full_address" type="text"
                ...
                <div class="col">
                  <div class="form-group">
                    ...
                    <input class="form-control" id="deal_size" name="deal_size" type="number" placeholder="Deal Size">
                  </div>
                </div>
              ...
              <div class="row">
                <div class="col">
                  <div class="form-group">
                    ...
                    <input class="form-control" id="close_won_date" name="close_won_date" type="date"
                      value="{{date('d/m/Y')}}" placeholder="Closed Won Date ">
                  </div>
                </div>
              ...
              <div class="row">
                ...
                <div class="col">
                  <div class="form-group">
                    ...
                    <input class="form-control" id="market_contact" name="market_contact" type="text"
              ...
              <div class="row">
                <div class="col">
                  <div class="form-group">
                    ...
                    <input class="form-control" id="marketing_phone" name="marketing_phone" type="number"
                ...
                <div class="col">
                  <div class="form-group">
                    ...
                    <input class="form-control" id="marketing_email" name="marketing_email" type="email"
              ...
              <div class="row">
                <div class="col">
                  <div class="form-group">
                    ...
                    <input class="form-control" id="billing_contact" name="billing_contact" type="text"
                ...
                <div class="col">
                  <div class="form-group">
                    ...
                    <input class="form-control" id="billing_address" name="billing_address" type="text"
        ...
        <a href="{{URL::to('/view-lead').'/'.$lead->id}}">
          <div class="col-sm-12 col-xl-4" style="float: left;">
            <div class="card card-absolute">
              <div
                class="card-header {{ \App\LedCategories::where('id',$lead->lead_status)->pluck('led_class')->first()}}">
              ...
              <div class="card-body lead-card-body">
                <div class="row">
                  <div class="col-md-6">
                    <p>Start Date :</p>
                    <h5 style="font-size: 18px;">{{ \Carbon\Carbon::parse($lead->created_at)->format('M d, Y')}}</h5>
                  </div>
                  <div class="col-md-6">
                    @if ($lead->assigned_to)                        
                    <p>Assigned To :</p>
                  ...
                  <div class="col-md-12">
                    <p>Status :</p>
                    <h5 style="font-size: 18px;">{{ \App\LedCategories::where('id',$lead->lead_status)->pluck('categori_name')->first()}}</h5>
                  </div>
                </div>
              </div>
            </div>
