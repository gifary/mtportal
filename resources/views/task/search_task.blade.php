                        ...
                        <div class="card-header">
                            <h5 class="mb-0">
                                ...
                                <button style="white-space: normal;" class="btn btn-link res-pons"
                                    ...
                                    <i class="fa fa-circle @if($task->status === 1) text-success @elseif($task->status === 2) text-warning @elseif($task->status === 3) text-primary  @elseif($task->status === 0) text-danger @else text-dark  @endif"></i>
