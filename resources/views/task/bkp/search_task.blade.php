                        ...
                        <div class="card-header">
                            <h5 class="mb-0">
                                <button style="white-space: normal;" class="btn btn-link res-pons"
                                    ...
                                    <span class="task-title-res" style="">{{$task->title}}</span>

                                    <div class="res-thumblins" style="">

                                        <p
                                            style="margin-top: -4px;font-size:16px; font-family: 'Open Sans', sans-serif; float: left;margin-right: 15px">
                                            {{$user->name}}</p>
                                        <p
                                            style="margin-right: 15px;margin-top: -1px;font-size:13px; font-family: 'Open Sans', sans-serif; float: left">
                                            {{ \Carbon\Carbon::parse($task->created_at)->format('d M, Y')  }}</p>

                                        <img class="attachedTo_logo"
                                            style="float: left;width: 30px;height: 30px;border-radius: 25px;border: .5px solid #51ea86;margin-top: -5px;"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-3">
                                        <label class="control-label "
                                            for="textinput">{{\App\User::where('id',$task->user_id)->pluck('name')->first()}}</label>
                                    </div>
